...
public class GameGrindSupport : EditorWindow {
    ...
    private void OnGUI()
    {
        ...
        if (GUILayout.Button("Send Email\nsupport@gamegrind.io", GUILayout.Height(35), GUILayout.Width(150)))
        {
            Application.OpenURL("mailto:support@gamegrind.io?subject=[JournalSupport]");
        }
        ...
        {
            Application.OpenURL("https://discord.gg/P8yCQ3u");
        }
        GUI.color = Color.white;
        EditorGUILayout.EndHorizontal();
        EditorGUILayout.BeginHorizontal(EditorStyles.helpBox);
        EditorGUILayout.LabelField("Community support is great, but can take time", EditorStyles.centeredGreyMiniLabel, GUILayout.Height(35));
        if (GUILayout.Button("Forum\nforum.gamegrind.io", GUILayout.Height(35), GUILayout.Width(150)))
        {
            Application.OpenURL("http://forum.gamegrind.io");
        }
        EditorGUILayout.EndHorizontal();
        EditorGUILayout.BeginHorizontal(EditorStyles.helpBox);
